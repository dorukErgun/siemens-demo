...
<html>
    ...
    <body>
        ...
        <div class="pusher">
            ...
            <h1>Active permission requests are listed as below.</h1>
                <table id="main-table" class="ui celled striped table" style="width:100%">
                    ...
                    <tbody>
                    <?php
                        while ($row = mysqli_fetch_assoc($result_for_permissions)) { ?>
                            <tr>
        ...
        <script>
            $('.edit').click(function(){
                ...
                var new_src = 'edit_permission_request.php?id=' + id;
                console.log(new_src);
        ...
        <script>
            $('.delete').click(function(){
                var id = $(this).attr('value');
                var new_src = 'delete_permission_request.php?id=' + id;
                console.log(new_src);
