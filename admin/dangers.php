...
<html>
    ...
    <body>
        ...
        <div class="pusher">
            ...
            <h1>Active dangers are listed as below.</h1>
                <table id="main-table" class="ui celled striped table" style="width:100%">
                    ...
                    <tbody>
                    <?php
                        while ($row = mysqli_fetch_assoc($result_for_dangers)) { ?>
                            <tr>
        ...
        <script>
            $('.edit').click(function(){
                ...
                var new_src = 'edit_danger.php?id=' + id;
                console.log(new_src);
        ...
        <script>
            $('.delete').click(function(){
                var id = $(this).attr('value');
                var new_src = 'delete_danger.php?id=' + id;
                console.log(new_src);
