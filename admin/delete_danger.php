...
<html>
    ...
    <body>
        ...
        <form class="ui form" action="script.php" method="post">
            <input type="hidden" name="action" value="delete_danger"> 
            <input type="hidden" name="id" value="<?php echo($id);?>"> 
                
            <div class="field">
                <label>Are you sure you want to delete <?php echo($row['fname']); echo " "; echo($row['lname']);  ?>'s danger warning?</label>
